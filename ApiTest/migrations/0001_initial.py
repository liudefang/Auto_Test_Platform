# Generated by Django 2.0.2 on 2019-10-09 19:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apiGroupLevelFirst', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='First', to='ApiTest.ApiGroupLevelFirst', verbose_name='所属一级分组')),
            ],
            options={
                'verbose_name': '接口',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ApiTest.ApiInfo', verbose_name='接口')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=1024, null=True, verbose_name='描述')),
                ('api', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requestParameter', to='ApiTest.ApiInfo', verbose_name='所属接口')),
            ],
            options={
                'verbose_name': '请求参数',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='requestParameterRaw', to='ApiTest.ApiInfo', verbose_name='所属接口')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=1024, null=True, verbose_name='描述')),
                ('api', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='response', to='ApiTest.ApiInfo', verbose_name='所属接口')),
            ],
            options={
                'verbose_name': '返回参数',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auto_result', to='ApiTest.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '自动测试结果',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='header', to='ApiTest.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '请求头',
                'verbose_name_plural': '请求头管理',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(blank=True, max_length=1024, null=True, verbose_name='内容')),
                ('interrelate', models.BooleanField(default=False, verbose_name='是否关联')),
                ('automationCaseApi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parameterList', to='ApiTest.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '接口参数',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='parameterRaw', to='ApiTest.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '源数据参数',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='response', to='ApiTest.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationGroupLevelFirst', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='automationGroup', to='ApiTest.AutomationGroupLevelFirst', verbose_name='所属用例一级分组')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='test_result', to='ApiTest.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '手动测试结果',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=1024, null=True, verbose_name='描述')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dynamic_project', to='ApiTest.Project', verbose_name='所属项目')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='member_project', to='ApiTest.Project', verbose_name='所属项目')),
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ApiTest.Project', verbose_name='项目'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='Host',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ApiTest.GlobalHost', verbose_name='HOST'),
        ),
        migrations.AddField(
            model_name='automationtesttask',
            name='project',
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ApiTest.Project', verbose_name='所属项目'),
        ),
        migrations.AddField(
            model_name='automationtestcase',
            name='user',
        ...
        migrations.AddField(
            ...
            name='automationTestCase',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='api', to='ApiTest.AutomationTestCase', verbose_name='用例'),
        ),
        migrations.AddField(
            model_name='apiinfo',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='api_project', to='ApiTest.Project', verbose_name='所属项目'),
        ),
        migrations.AddField(
            model_name='apiinfo',
            name='userUpdate',
        ...
        migrations.AddField(
            model_name='apihead',
            name='api',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='headers', to='ApiTest.ApiInfo', verbose_name='所属接口'),
        ),
        migrations.AddField(
