<template>
    <div style="margin:35px">
      ...
      <el-table :data="project" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%">
        ...
        <el-table-column prop="host" label="HOST" min-width="28%" sortable show-overflow-tooltip></el-table-column>
        <el-table-column prop="description" label="描述" min-width="27%" sortable show-overflow-tooltip></el-table-column>
      ...
      <el-col :span="24" class="toolbar">
        ...
        <el-pagination layout="prev, pager, next" @current-change="handleCurrentChange" :page-size="20" :page-count="total" style="float:right;"></el-pagination>
      </el-col>
...
<script>
  import {addHost, getHost} from "../../../api/api";
                ...
                this.$refs.addForm.validate((valid) => {
                    if (valid) {
                        let self = this;
                            ...
                            addHost(header, params).then(_data => {
                                let {msg, code, data} = _data;
